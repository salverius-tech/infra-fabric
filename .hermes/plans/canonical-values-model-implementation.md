...
- [~] Exclude Ansible-only, runtime-only, and unnecessary secret values. Projections now fail closed on recursively detected sensitive field names; explicit allow-listed schemas and consumer-specific exclusions remain.
