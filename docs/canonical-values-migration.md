...
Legacy import and forensic compatibility tooling has been retired after the disposable development controller/infrastructure recovery rehearsal. Do not hand-copy old inputs into `site.yaml`, `generated/`, or a new plan. The normal recovery sequence is:
