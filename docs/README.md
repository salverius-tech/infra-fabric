...
- [Bounded legacy recovery-tool inventory](legacy-recovery-tool-inventory.md) — quarantined compatibility callers, recovery justifications, and triggered deletion manifest.
