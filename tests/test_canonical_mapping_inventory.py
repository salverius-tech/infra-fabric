...
class CanonicalMappingInventoryTests(unittest.TestCase):
    def test_current_sources_are_fully_classified(self) -> None:
        ...
        self.assertEqual(report["matrix_path_coverage"]["checked_count"], 245)
        self.assertEqual(report["matrix_path_coverage"]["valid_count"], 245)
        ...
        self.assertEqual(report["consumer_evidence"]["missing_exact_evidence_count"], 49)
        self.assertEqual(report["consumer_evidence"]["status"], "review-required")
